...
DATASET_PATH = os.path.join(BASE_DIR, "definition_classification_test.tsv")
OUTPUT_PATH = os.path.join(BASE_DIR, "definition_tinyllama.csv")
...
Determine whether the following sentence defines a legal term.

A definition usually explains the meaning of a term using phrases like
"means", "refers to", or "is defined as".
