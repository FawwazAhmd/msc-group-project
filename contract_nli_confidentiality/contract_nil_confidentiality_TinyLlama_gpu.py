...
from contract_qa.contract_qa_phi3_gpu import PLOT_PATH
...
OUTPUT_PATH = os.path.join(BASE_DIR, "tinyllama_confidentiality_results_improved_prompt.csv")
...
if not torch.cuda.is_available():
    raise RuntimeError("CUDA is not available. Use CPU / Colab instead.")
...
Decide if the statement implies confidentiality.
