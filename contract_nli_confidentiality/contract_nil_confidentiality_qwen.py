...
OUTPUT_PATH = os.path.join(BASE_DIR, "qwen_confidentiality_simple.csv")
...
# Inputing the simple prompt template
def create_prompt(clause):
    return f"""
You are a legal expert.

Does the following contract clause imply confidentiality of the agreement?
