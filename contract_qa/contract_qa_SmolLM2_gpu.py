...
OUTPUT_PATH = os.path.join(BASE_DIR, "contract_qa_temperature_results_smollm2.csv")
PLOT_PATH = os.path.join(BASE_DIR, "temperature_vs_f1_smollm2.png")
...
plt.ylabel("F1 Score")
plt.title("Temperature vs F1 Score (SmolLM2 Contract QA)")
plt.grid(True)
