...
DATASET_PATH = os.path.join(BASE_DIR, "opp115_do_not_track_test.tsv")
OUTPUT_PATH = os.path.join(BASE_DIR, "dnt_tinyllama.csv")
...
Determine whether the following privacy policy clause explains how the website responds to "Do Not Track" (DNT) signals or browser tracking preferences.

This includes mentions of "Do Not Track", "DNT", or whether tracking preferences are honored or ignored.
