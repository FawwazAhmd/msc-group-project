...
DATASET_PATH = os.path.join(BASE_DIR, "opp115_data_retention_test.tsv")
OUTPUT_PATH = os.path.join(BASE_DIR, "retention_tinyllama.csv")
...
Determine whether the following privacy policy clause mentions how long user data is stored or retained.

This includes statements about duration, time periods, or how long data is kept (e.g., "retain for X years", "stored until", "kept as long as necessary").
