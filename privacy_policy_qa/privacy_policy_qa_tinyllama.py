...
DATASET_PATH = os.path.join(BASE_DIR, "privacy_policy_qa_test.tsv")
OUTPUT_PATH = os.path.join(BASE_DIR, "privacy_policy_qa_tinyllama.csv")
...
Determine whether the given privacy policy clause contains the answer to a specific privacy-related question.
